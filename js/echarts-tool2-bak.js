...
function wbzl() {
    ...
    var data = [[0, 0, 5], [0, 1, 1], [0, 2, 2], [0, 3, 8], [1, 0, 3], [1, 1, 5], [1, 2, 1], [1, 3, 9], [2, 0, 4], [2, 1, 8], [2, 2, 4], [2, 3, 8], [3, 0, 6], [3, 1, 7], [3, 2, 4], [3, 3, 9],];
    option = {
        title: {
            text: ''
        },
...
function yqbj() {
    ...
    option = {
        ...
        tooltip: {show: false, backgroundColor: 'rgba(0,0,0,0.9)',},
        xAxis3D: {
            type: 'category',
            data: ['09月', '10月', '11月'],
            axisLine: {lineStyle: {color: "rgba(255,255,255,.1)", width: 1, type: "solid"},},
            axisLabel: {interval: 0, rotate: 45, textStyle: {color: '#fff', fontSize: 12,}},
        },
        yAxis3D: {
            type: 'category',
            data: [''],
        ...
        zAxis3D: {type: 'value', axisLine: {lineStyle: {color: '#0f0', width: 1}},},
        grid3D: {
            boxWidth: 250,
            boxDepth: 2,
            ...
            itemStyle: {
                normal: {
                    color: function (params) {
                        var colorList = ["#37b70c", "#dd3f36", "#d0a00e"];
                        return colorList[params.dataIndex]
                    },
                }
            },
            data: [[0, 0, 100], [1, 0, 20], [2, 0, 60],],
            stack: 'stack',
            shading: 'lambert',
...
function wwbzl() {
    ...
    var data = [{name: "做饭", value: "355"}, {name: "粉尘", value: "193"}, {name: "误报", value: "874"}, {
        name: "其它",
        value: "427"
    }, {name: "吸烟", value: "308"},];
    var offsetData = [[80, 53], [35, 73], [30, 33], [60, 33], [10, 48]];
    ...
    var option = {
        ...
        series: [{
            ...
            symbol: "circle",
            symbolSize: 120,
            label: {normal: {show: true, formatter: "{b}", color: "#fff", textStyle: {fontSize: "20"}}},
    ...
    setInterval(function () {
        wwbzl.setOption({
            graphic: [{id: 'logo', rotation: -(rotation += Math.PI / 860) % (Math.PI * 2),}, {
                id: 'logo1',
                rotation: -(rotation += Math.PI / 640) % (Math.PI * 2),
            }, {id: 'logo2', rotation: -(rotation += Math.PI / 360) % (Math.PI * 2),}, {
                id: 'logo3',
...
function test() {
    ...
    var plantCap = [{name: '工业', value: '222'}, {name: '农业', value: '115'}, {
        name: '互联网',
        value: '113'
    }, {name: '医疗', value: '95'}, {name: '文学', value: '92'}, {name: '服装', value: '87'}];
    var datalist = [{offset: [56, 48], symbolSize: 110, color: 'rgba(73,188,247,.14)',}, {
        offset: [30, 70],
        symbolSize: 70,
        color: 'rgba(73,188,247,.14)'
    }, {offset: [0, 43], symbolSize: 60, color: 'rgba(73,188,247,.14)'}, {
        offset: [93, 30],
        symbolSize: 70,
        color: 'rgba(73,188,247,.14)'
    }, {offset: [26, 19], symbolSize: 65, color: 'rgba(73,188,247,.14)'}, {
        offset: [75, 75],
        symbolSize: 60,
        color: 'rgba(73,188,247,.14)'
    }];
    ...
    for (var i = 0; i < plantCap.length; i++) {
        ...
        datas.push({
            ...
            label: {normal: {textStyle: {fontSize: 14}}},
    ...
    option = {
        ...
        series: [{
            ...
            symbol: 'circle',
            symbolSize: 120,
            label: {normal: {show: true, formatter: '{b}', color: '#FFF', textStyle: {fontSize: '30'}},},
            itemStyle: {normal: {color: '#F30'}},
            data: datas
        }]
    };
...
function sbj() {
    ...
    let {date, in_data, out_data} = {date: [], in_data: [], out_data: []};
    ...
    option = {
        title: [{
            ...
            y: '40',
            textBaseline: 'middle',
            textStyle: {color: '#cccccc', fontSize: 16, fontWeight: '100'}
        }, {
            text: '最新',
            x2: 215,
            y: '10',
            textBaseline: 'middle',
            textStyle: {color: "#fff", fontSize: 12, fontWeight: '100'}
        }, {
            text: '最小',
            x2: 145,
            y: '10',
        ...
        yAxis: [{
            ...
            axisTick: {show: false},
            axisLine: {lineStyle: {color: '#57617B'}},
            axisLabel: {formatter: '{value}MPa', textStyle: {color: "rgba(255,255,255,.6)", fontSize: 12}},
        ...
        series: [{
            ...
            itemStyle: {normal: {color: 'rgba(0,0,255)'}},
            areaStyle: {
                normal: {
            ...
            showSymbol: false,
            lineStyle: {normal: {width: 0}},
            itemStyle: {normal: {color: 'rgba(0,255,0)'}},
            areaStyle: {
                normal: {
                    color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                        offset: 0,
                        color: 'rgba(0,255,0,1)'
                    }, {offset: 0.8, color: 'rgba(0,255,0, 0.5)'}])
                },
            },
            data: in_data
        }]
    ...
    setInterval(function () {
        ...
        myChart.setOption({
            title: [{text: ''}, {text: ''}, {text: '最新'}, {text: '最小',}, {text: '最大'}, {text: '平均'}, {text: in_new}, {text: in_min}, {text: in_max}, {text: in_avg}, {text: out_new}, {text: out_min}, {text: out_max}, {text: out_avg}],
            series: [{data: out_data}, {data: in_data}],
            xAxis: [{data: date}],
        })
    }, 1000);
    myChart.setOption(option);
...
function dbj() {
    ...
    option = {
        ...
        toolbox: {show: false, feature: {restore: {show: true}, saveAsImage: {show: true}}},
        series: [{
            // name: '温度1',
            type: 'pie',
            center: ['45%', '40%'],
            ...
            radius: '73%',
            axisLine: {lineStyle: {color: [[0.2, '#7FFF00'], [0.8, '#00FFFF'], [1, '#FF0000']], width: 6}},
            axisTick: {length: 5, lineStyle: {color: 'auto'}},
            splitLine: {length: 20, lineStyle: {color: 'auto'}},
            pointer: {width: 2},
            title: {textStyle: {fontWeight: 'normal', color: '#fff', fontSize: 12, offsetCenter: ['15%', '-20%'],}},
            detail: {textStyle: {fontWeight: 'normal', fontSize: 12}},
            data: [
                    {value: 400, name: '新浪'},
                    {value: 89, name: '市政府'},
                    {value: 32, name: '文旅局'},
   ...
   /* option = {
        legend: {
            top: 'bottom',
            itemWidth: 8,  // 调整图例项宽度
            itemHeight: 8, // 调整图例项高度
            textStyle: {
                fontSize: 14 // 调整图例文字大小
            }
        },
        toolbox: {
            show: true,
